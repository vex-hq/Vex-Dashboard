...
const PathsSchema = z.object({
  ...
  app: z.object({
    ...
    accountExecutionSessions: z.string().min(1),
    accountExecutionSessionDetail: z.string().min(1),
    accountMemory: z.string().min(1),
    accountPrivate: z.string().min(1),
    accountInbox: z.string().min(1),
    accountContext: z.string().min(1),
    accountShared: z.string().min(1),
    accountSetup: z.string().min(1),
    accountProposals: z.string().min(1),
    accountProjects: z.string().min(1),
    accountProjectDetail: z.string().min(1),
...
const pathsConfig = PathsSchema.parse({
  ...
  app: {
    ...
    accountExecutionSessions: '/home/[account]/execution-sessions',
    accountExecutionSessionDetail:
      '/home/[account]/execution-sessions/[sessionId]',
    accountMemory: '/home/[account]/memory',
    accountPrivate: '/home/[account]/private',
    accountInbox: '/home/[account]/inbox',
    accountContext: '/home/[account]/context',
    accountShared: '/home/[account]/shared',
    accountSetup: '/home/[account]/setup',
    accountProposals: '/home/[account]/proposals',
    accountProjects: '/home/[account]/projects',
    accountProjectDetail: '/home/[account]/projects/[projectId]',
